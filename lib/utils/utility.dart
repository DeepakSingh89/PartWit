...
class Utility {
  ...
  ///get time stamp
  static String readTimestamp(DateTime dateTime) {
  ...
  ///round of range price
  static int calc_range(range) {
    double multiplier = 250.0;
    return (multiplier * range).round();
  }
  ...
  static deleteValue(String data) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs = await SharedPreferences.getInstance();
    prefs.remove(data);
  }

  static checkKey(String data) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs = await SharedPreferences.getInstance();
    bool hasKey = prefs.containsKey(data);
    print(' test delete  ${hasKey}');
    return hasKey;
  }

  static String imgTobase64Encode(String path  ) {
  ...
  static String ImgTobase64Decode(String path) {
    final bytes = File(path).readAsBytesSync();
    Uint8List decoded = base64Decode(base64Encode(bytes));
  ...
  ///convert int to double code
  static  IntToDouble(int? value) {
    double doubleVar = value!.toDouble();
    return doubleVar ;
  }

///string to encode base64
static String  StringToEncode(String path){
  final bytes = File(path).readAsBytesSync();
